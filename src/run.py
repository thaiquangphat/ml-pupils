...
if __name__ == "__main__":
    ...
    if args.model == "bayes_net":
        visualize_module = importlib.import_module("models.bayes_net.visualize")
        visualize_module.visualize(saved_path=saved_path, args=args.model_args)
    else:
        logger.info(f"No visualize function defined for model: {args.model}")
